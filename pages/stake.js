      ...
      <div className="max-w-4xl mx-auto">
          ...
          {!isConnected ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 max-w-md mx-auto">
                We're working on bringing you the best staking experience. Check
                back soon to stake your tokens and earn rewards.
              </p>
              <div className="mt-8 p-4 bg-blue-50 rounded-lg">
                <p className="text-sm text-blue-700">
                  💡 In the meantime, try our swap feature to exchange tokens at
                  the best rates!
                </p>
              </div>
            </div>
        ...
        <div className="mt-8 grid md:grid-cols-3 gap-4">
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
            ...
            <p className="text-sm text-gray-600">Support for various tokens</p>
          </div>
        </div>
      </div>
    </div>
